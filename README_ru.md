...
>
> **Расширение через Skills** — Встроенные планировщик задач, обработка PDF/Office, дайджесты новостей и многое другое; пользовательские навыки загружаются автоматически, без привязки. Skills определяют возможности QwenPaw.
>
...
[2026-04-09] Выпущена версия v1.0.2! Полный список изменений — в [примечаниях к выпуску v1.0.2](https://agentscope-ai.github.io/QwenPaw/release-notes).

- **[v1.0.2] Добавлено:** Поддержка системы плагинов; `qwenpaw task` без веб-интерфейса; переключение моделей через `/model` в чате; провайдер SiliconFlow; мультимодальность QwenPaw Local и расширенные настройки консоли; шифрование чувствительных учётных данных; команды `/skills` и `/<имя_навыка>` для списка и вызова навыков; теги пула навыков.
...
[2026-04-04] Выпущена версия v1.0.1! Полные изменения см. в [примечаниях к выпуску v1.0.1](https://agentscope-ai.github.io/QwenPaw/release-notes).

- **[v1.0.1] Добавлено:** Поддержка моделей Zhipu AI; анализ видео для мультимодальных моделей; конфигурация параметров генерации для каждой модели; автообновление QwenPaw Local; канал OneBot v11 для NapCat/QQ; упорядочивание агентов перетаскиванием; пакетные операции со навыками; улучшения загрузки файлов и индикатора набора WeChat; дополнительные инструкции для ручного сжатия.
...
- **[v1.0.1] Документация:** FAQ по развертыванию QwenPaw-Flash; обновления документации по навыкам.
...
[2026-03-30] Выпущена версия v1.0.0! Полные изменения см. в [примечаниях к выпуску v1.0.0](https://agentscope-ai.github.io/QwenPaw/release-notes).
...
- **[v1.0.0] Добавлено:**
  ...
  - **Провайдеры и модели**: Провайдер локальных моделей QwenPaw с llama.cpp; глобальный ограничитель скорости LLM с QPM скользящим окном
...
[2026-03-24] Выпущена версия v0.2.0! Полные изменения см. в [примечаниях к выпуску v0.2.0](https://agentscope-ai.github.io/QwenPaw/release-notes).

[2026-03-18] Выпущена версия v0.1.0! Полные изменения см. в [примечаниях к выпуску v0.1.0](https://agentscope-ai.github.io/QwenPaw/release-notes).

[2026-03-12] Выпущена версия v0.0.7! Полные изменения см. в [примечаниях к выпуску v0.0.7](https://agentscope-ai.github.io/QwenPaw/release-notes).
